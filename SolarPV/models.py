...
class User(models.Model):
    ...
    prefix = models.CharField(max_length=8, choices=(('Dr.', _('DR.')), ('Mr.', _('MR.')), ('Mrs.', _('MRS.'))))
...
class Location(models.Model):
	...
	clientID= models.ForeignKey('Client', on_delete=models.SET_NULL, null=True)
    address1 = models.TextField(max_length=200, help_desk= "Enter the full address including city, state, zip")
    address2 = models.TextField(max_length=200, help_desk= "Enter the full address including city, state, zip")
    city = models.CharField(max_length=50)
    state = models.CharField(max_length=50)
    postalcode = models.IntegerField(max_length=12)
...
class Product(models.Model):
    ...
    numberofcells = models.IntegerField(max_length=12)
    numberofcellsinseries = models.IntegerField(max_length=12)   
    numberofseriesinstrings = models.IntegerField(max_length=12) 
    number of diodes = models.IntegerField(max_length=12)
...
class PerformanceData(models.Model):
    ...
    sequenceID = models.ForeignKey('Product', on_delete=models.SET_NULL, null=True)
...
class Certificate(models.Model):
    ...
    userID= models.ForeignKey('Location', on_delete=models.SET_NULL, null=True)
    standardID= models.ForeignKey('TestStandard', on_delete=models.SET_NULL, null=True)
    modelNum = models.ForeignKey('Product', on_delete=models.SET_NULL, null=True)
